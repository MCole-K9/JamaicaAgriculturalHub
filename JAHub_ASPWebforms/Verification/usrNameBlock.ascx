...
<div class="row">
    ...
    <div class="row">
        <asp:Label runat="server" ID="lblFirstName" BorderStyle="None" CssClass="text text-right col-lg-3 input-sm">First Name</asp:Label>
    ...
    <div class="row">
        <asp:Label runat="server" ID="lblLastName" CssClass="text text-right col-lg-3 input-sm">Last Name</asp:Label>
