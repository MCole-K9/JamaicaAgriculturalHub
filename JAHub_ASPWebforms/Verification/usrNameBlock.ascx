...
<div class="row">
    ...
    <div class="row">
        <asp:Label runat="server" ID="lblFirstName" BorderStyle="None" CssClass="text text-right col-lg-2 input-sm">First Name</asp:Label>
    ...
    <div class="row">
        <asp:Label runat ="server" ID="lblMiddleName" CssClass="text text-right col-lg-2 input-sm">Middle Name</asp:Label>
    ...
    <div class="row">
        <asp:Label runat="server" ID="lblLastName" CssClass="text text-right col-lg-2 input-sm">Last Name</asp:Label>
