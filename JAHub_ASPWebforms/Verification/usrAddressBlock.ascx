...
<div class="row">
    <div class="row">
        <asp:Label runat="server" ID="lblAddressTown" CssClass="col-lg-3 text input-sm">Town</asp:Label>
        <asp:TextBox runat="server" ID="txtAddressTown" CssClass="col-lg-3 input-sm"></asp:TextBox>
    ...
    <div class="row">
        <asp:Label runat="server" ID="lblAddressPostOffice" CssClass="col-lg-3 text input-sm">PO Box</asp:Label>
        <asp:TextBox runat="server" ID="txtAddressPostOffice" CssClass="col-lg-3 input-sm"></asp:TextBox>
    ...
    <div class="row">
        <asp:Label runat="server" ID="lblAddressParish" CssClass="col-lg-3 text input-sm">Parish</asp:Label>
        <asp:TextBox runat="server" ID="txtAddressParish" CssClass="col-lg-3 text input-sm"></asp:TextBox>
