<%@ Page Language="C#" AutoEventWireup="true" Title="Edit" CodeBehind="EditBlog.aspx.cs" Inherits="JAHub_ASPWebforms.EditBlog" MasterPageFile="~/Site.Master"%>
    ...
    <asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div>
            ...
            <asp:button type="button" class="btn btn-primary btnPost" runat="server" id="btnPost" OnClick="btnPost_Click" Text="Save"></asp:button>
